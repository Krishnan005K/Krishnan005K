...
Software Developer from 🇮🇳 with hands-on experience in building scalable backend systems, full-stack web applications, and enterprise PLM solutions. 

Currently specializing in **Java, Spring Boot, React.js, and Siemens Teamcenter customization**. I bridge the gap between robust software engineering fundamentals and enterprise-level application lifecycle management.
...
*   **Frontend & Databases:** React.js, HTML5 & CSS3, MongoDB, MySQL
*   **Automation & Customization:** Teamcenter Stylesheet Customization, Build & Deployment Automation
...
- Deepening enterprise exposure through Teamcenter BMIDE configuration and lifecycle customization  
- Leveraging automation scripts (PowerShell/Batch) to streamline deployment workflows  
- Preparing for SDE-1 roles in product-based companies  
...
- Workflow & Build Automation Strategies  
- System Design Basics & Scalable Development  
